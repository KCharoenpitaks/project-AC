...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        #self.episode_limit = map_params["limit"] #edit for better step
    ...
    def step(self, actions):
        ...
        terminated = False
        reward, Running_away_from_battle = self.reward_battle()
        ...
        return reward, terminated, info, Running_away_from_battle
    ...
    def reward_battle(self):
        ...
        #print(sum(self.death_tracker_ally),"''''''''''''''''''''")
        #print(len(self.death_tracker_ally))
        if ((sum(self.death_tracker_ally) < len(self.death_tracker_ally)) and (sum(self.death_tracker_enemy)<len(self.death_tracker_enemy))):
            Running_away_from_battle = 1
        else:
            Running_away_from_battle = 0
        return reward, Running_away_from_battle
